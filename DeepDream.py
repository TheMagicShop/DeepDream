...
during the training process we are going to maximize given layers' outputs (activations) "f(x)" wit regard to
...
the plot_final_image property plot actually the final edited (dreamt) image.

the dream method yield an mp4 video file enchaining all the versions of the input image after 
